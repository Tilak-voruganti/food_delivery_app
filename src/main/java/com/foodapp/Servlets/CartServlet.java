...
public class CartServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            session.setAttribute("cart", cart);
            if ("add".equals(action) || "menu".equals(req.getParameter("returnTo"))) {
                String itemId = req.getParameter("itemId");
                if (itemId == null) {
                    itemId = req.getParameter("menuId");
                }
                resp.sendRedirect("menu?restaurantId=" + newRestaurantId + "#menu-item-" + itemId);
            } else {
    ...
    private void addItemToCart(HttpServletRequest req, Cart cart, int restaurantId) throws Exception {
        ...
        if (existingItem == null) {
            CartItem item = new CartItem(menuId, restaurantId, menuItem.getItemname(), quantity,
                    menuItem.getPrice(), quantity * menuItem.getPrice());
